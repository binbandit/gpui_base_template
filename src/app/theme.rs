...
impl Theme {
    ...
    pub fn from_mode(mode: ThemeMode) -> Self {
        match mode {
            ThemeMode::Dark => Self {
                mode,
                canvas: color(0x111820),
                sidebar: color(0x0D131A),
                surface: color(0x18222D),
                surface_hover: color(0x202D39),
                surface_muted: color(0x141D26),
                text: color(0xF5F1EA),
                text_muted: color(0xA9B2BA),
                text_faint: color(0x8996A1),
                border: color(0x283746),
                border_strong: color(0x3B4D5D),
                focus_ring: color(0x78B9FF),
                accent: color(0xF2A365),
                accent_hover: color(0xFFB47A),
                accent_ink: color(0x17202B),
                success: color(0x6FCF97),
                warning: color(0xF2C56B),
                danger: color(0xF07E7E),
            },
            ThemeMode::Light => Self {
                mode,
                canvas: color(0xF5F1EA),
                sidebar: color(0xEAE4DA),
                surface: color(0xFFFCF7),
                surface_hover: color(0xF4ECE2),
                surface_muted: color(0xF0EAE1),
                text: color(0x202830),
                text_muted: color(0x59636C),
                text_faint: color(0x5C656D),
                border: color(0xD9D0C4),
                border_strong: color(0xBFB3A4),
                focus_ring: color(0x005FCC),
                accent: color(0xB84C24),
                accent_hover: color(0xA9411D),
                accent_ink: color(0xFFFFFF),
                success: color(0x26734A),
                warning: color(0x81520D),
                danger: color(0xB94B4B),
            },
        }
    }
}
